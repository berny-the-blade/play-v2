              ...
              <div className="felt-bg rounded-xl p-2 mb-3 relative" style={{ border: '1px solid rgba(255,255,255,0.08)', flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                ...
                <div className="flex items-stretch mb-1 gap-1" style={{ flex: 1, minHeight: 0 }}>
                  ...
                  <div ref={boardRef} className="board-area"
                    ...
                    <div style={{
                      /* 2026-07-24: top/left:3 (was 0). The extreme "0" tick sits at
                         the pivot's coordinate, ~0.5px inside the board's overflow:
                      ...
                      position: 'absolute', top: 12, left: 12, zIndex: dialPulse === 'team0' ? 30 : 10, pointerEvents: 'none',
                    ...
                    <div style={{
                      ...
                      position: 'absolute', bottom: 12, right: 12, zIndex: dialPulse === 'team1' ? 30 : 10, pointerEvents: 'none',
